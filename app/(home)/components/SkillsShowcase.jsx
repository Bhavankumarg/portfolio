...
import { SiExpress, SiMongodb, SiTailwindcss, SiFigma, SiGreensock, SiThreedotjs, SiJavascript, SiMaterialdesign, SiNextdotjs, SiTypescript, SiPython, SiBootstrap, SiAdobexd } from 'react-icons/si';
import { TbBrandFramerMotion } from 'react-icons/tb';

const skills = [
    // { name: "AWS", icon: <FaAws className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Next.js", icon: <SiNextdotjs className="w-5 h-5 sm:w-6 sm:h-6 " />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    ...
    { name: "Bootstrap", icon: <SiBootstrap className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    ...
    { name: "Tailwind", icon: <SiTailwindcss className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    ...
    { name: "Figma", icon: <SiFigma className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "AdobeXD", icon: <SiAdobexd className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
